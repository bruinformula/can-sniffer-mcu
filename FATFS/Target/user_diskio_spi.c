...
#include "stm32f0xx_hal.h" /* Provide the low-level HAL functions */
...
#define FCLK_SLOW() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_CR1_BR, SPI_BAUDRATEPRESCALER_256); }	/* Set SCLK = slow, approx 365 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_CR1_BR, SPI_BAUDRATEPRESCALER_8); }	/* Set SCLK = fast, approx 6 MBits/s */
